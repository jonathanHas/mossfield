            ...
            <form method="POST" action="{{ route('products.variants.update', [$product, $variant]) }}" enctype="multipart/form-data" class="p-5">
                ...
                <div class="mb-4 p-3 rounded-md" style="background: var(--warn-soft); border: 1px solid var(--warn-soft-border);">
                    ...
                    <div class="space-y-2">
                        ...
                        <label class="flex items-start">
                            <input type="checkbox" name="is_bulk_weighed" value="1" {{ old('is_bulk_weighed', $variant->is_bulk_weighed) ? 'checked' : '' }} class="mt-0.5 mf-checkbox">
                            <span class="ml-2">
                ...
                <div class="mb-4">
                    ...
                    <input type="number" name="case_size" id="case_size" value="{{ old('case_size', $variant->case_size) }}" step="1" min="1" max="9999" class="mf-input"
                           placeholder="e.g., 16">
