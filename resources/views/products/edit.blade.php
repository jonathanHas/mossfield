            ...
            <div class="bg-white overflow-hidden shadow-sm sm:rounded-lg">
                <div class="p-6 text-gray-900">
                    <form method="POST" action="{{ route('products.update', $product) }}">
                        ...
                        <div class="mt-6" id="maturation-field" style="{{ old('type', $product->type) === 'cheese' ? 'display: block;' : 'display: none;' }}">
                            <x-input-label for="maturation_days" :value="__('Maturation Days')" />
                            <x-text-input id="maturation_days" class="block mt-1 w-full" type="number" name="maturation_days" :value="old('maturation_days', $product->maturation_days)" min="1" />
                        ...
                        <div class="flex items-center justify-end mt-6">
                            <a href="{{ route('products.show', $product) }}" class="bg-gray-500 hover:bg-gray-700 text-white font-bold py-2 px-4 rounded mr-2">
                                Cancel
                            </a>
                            <x-primary-button>
                                {{ __('Update Product') }}
