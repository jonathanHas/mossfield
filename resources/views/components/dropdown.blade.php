...
$alignmentClasses = match ($align) {
    ...
    'top' => 'origin-top mt-2',
    'top-start' => 'ltr:origin-bottom-left rtl:origin-bottom-right start-0 bottom-full mb-2',
    'top-end' => 'ltr:origin-bottom-right rtl:origin-bottom-left end-0 bottom-full mb-2',
