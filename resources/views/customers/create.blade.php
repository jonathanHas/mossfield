        ...
        <div class="mf-panel">
            <form method="POST" action="{{ route('customers.store') }}" class="p-5">
                ...
                <div class="grid grid-cols-1 md:grid-cols-2 gap-4 mb-6">
                    ...
                    <div>
                        ...
                        <input type="number" name="delivery_charge_percent" id="delivery_charge_percent"
                               value="{{ old('delivery_charge_percent') }}" step="0.01" min="0" max="100" class="mf-input">
                ...
                <div class="mb-6">
                    ...
                    <div class="flex items-center mt-3">
                        <input type="checkbox" name="requires_reference" id="requires_reference" value="1" {{ old('requires_reference') ? 'checked' : '' }} class="mf-checkbox">
